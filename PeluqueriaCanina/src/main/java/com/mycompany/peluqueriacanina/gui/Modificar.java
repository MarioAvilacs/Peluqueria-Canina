...
public class Modificar extends javax.swing.JFrame {
    ...
    public Modificar(int numCliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 450, 230, 60));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        controller.modificarMascota(mascota, nombre, raza, color, alergico, atenEspecial,
                nomDuenio, celDuenio, observaciones);

        mostrarMensaje("¡Se modificaron los datos correctamente!", "Informacion", "Registro Exitosa");
    ...
    private void cargarDatos(int numCliente) {
        ...
        this.mascota = controller.traerMascota(numCliente);
        ...
        if (mascota.getAtenEspecial().equals("SI")) {
            cmbAtenEspecial.setSelectedIndex(1);
        } else if (mascota.getAtenEspecial().equals("NO")) {
